...
<qgis version="2.4.0-Chugiak" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~CASE WHEN  &quot;CODE&quot; = '6500' THEN  color_rgb( 72, 72, 72 ) ELSE color_rgb( 146, 146, 146 ) END~~"/>
    <property key="labeling/dataDefined/Rotation" value="0~~0~~~~TEXT_ANGLE"/>
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" name="text_angle"/>
    <edittype labelontop="0" editable="1" name="text_size"/>
