...
<qgis version="2.6.1-Brighton" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <renderer-v2 attr="classifica" symbollevels="0" type="categorizedSymbol">
    <categories>
      <category render="false" symbol="0" value="Light Rapid Transit Station" label="Light Rapid Transit Station"/>
      <category render="false" symbol="1" value="Light Rapid Transit Station And Railway Station" label="Light Rapid Transit Station And Railway Station"/>
      <category render="true" symbol="2" value="Railway Station" label="Railway Station"/>
      <category render="false" symbol="3" value="Light Rapid Transit Station And London Underground Station" label="Light Rapid Transit Station And London Underground Station"/>
      <category render="false" symbol="4" value="London Underground Station" label="London Underground Station"/>
      <category render="false" symbol="5" value="Railway Station And London Underground Station" label="Railway Station And London Underground Station"/>
    </categories>
    <symbols>
      ...
      <symbol alpha="1" type="marker" name="2">
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="255,255,255,204"/>
          <prop k="horizontal_anchor_point" v="1"/>
        ...
        <layer pass="0" class="SimpleMarker" locked="0">
          <prop k="angle" v="0"/>
          <prop k="color" v="204,231,252,255"/>
          <prop k="horizontal_anchor_point" v="1"/>
          <prop k="name" v="rectangle"/>
          <prop k="offset" v="0,0"/>
          <prop k="offset_map_unit_scale" v="0,0"/>
