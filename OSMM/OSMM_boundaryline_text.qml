...
<qgis version="2.0.1-Dufour" minimumScale="1" maximumScale="100000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <edittypes>
    ...
    <edittype labelontop="0" editable="1" type="0" name="text_string"/>
    <edittype labelontop="0" editable="1" type="0" name="textrendering_anchorposition"/>
    <edittype labelontop="0" editable="1" type="0" name="textrendering_font"/>
    <edittype labelontop="0" editable="1" type="0" name="textrendering_height"/>
    <edittype labelontop="0" editable="1" type="0" name="textrendering_orientation"/>
