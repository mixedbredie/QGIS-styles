...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="3701" filter="featurecode = 15033" symbol="0" scalemindenom="1000" label="Urban general pecked detail - 1:1,000 to 1:3,701"/>
      <rule scalemaxdenom="10001" filter="featurecode = 15033" symbol="1" scalemindenom="3701" label="Urban general pecked detail - 1:3,701 to 1:10,000"/>
      <rule scalemaxdenom="3701" filter="featurecode = 15031" symbol="2" scalemindenom="1000" label="Urban general line detail - 1:1,000 to 1:3,701"/>
      <rule scalemaxdenom="10001" filter="featurecode = 15031" symbol="3" scalemindenom="3701" label="Urban general line detail - 1:3,701 to 1:10,000"/>
    </rules>
    <symbols>
