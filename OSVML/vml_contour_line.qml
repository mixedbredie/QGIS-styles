...
<qgis version="2.0.1-Dufour" minimumScale="0" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="6001" filter="featurecode = 15400" symbol="0" scalemindenom="1000" label="Standard contour - 1:1,000 to 1:6000"/>
      <rule scalemaxdenom="6001" filter="featurecode = 15401" symbol="1" scalemindenom="1000" label="Index contour - 1:1,000 to 1:6000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="234,171,87,255"/>
          <prop k="customdash" v=""/>
