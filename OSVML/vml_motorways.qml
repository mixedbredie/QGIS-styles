...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="10001" filter="featurecode = 15710" symbol="0" scalemindenom="1000" label="Motorway - 1:1,000 to 1:10000"/>
      <rule scalemaxdenom="10000" filter="featurecode = 15710" scalemindenom="1000" label="Motorway labels - 1:1,000 to 1:10,000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="color" v="137,199,219,255"/>
          <prop k="customdash" v=""/>
