...
<qgis version="2.4.0-Chugiak" minimumScale="-4.65661e-10" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="3701" filter="featurecode = 15780" scalemindenom="1000" label="Private road labels - 1:1,000 to 1:3,701"/>
      <rule scalemaxdenom="5001" filter="featurecode = 15780" scalemindenom="3701" label="Private road labels - 1:3,701 to 1:5,000"/>
      <rule scalemaxdenom="2501" filter="featurecode = 15780" symbol="0" scalemindenom="1000" label="Private road - 1:1,000 to 1:2,500"/>
    </rules>
    <symbols>
