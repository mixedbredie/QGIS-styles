...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="10001" filter="featurecode = 15743 OR featurecode = 15740" symbol="0" scalemindenom="1000" label="B road - 1:1,000 to 1:10000"/>
      <rule scalemaxdenom="10000" filter="featurecode = 15743 OR featurecode = 15740" scalemindenom="1000" label="B road labels - 1:1,000 to 1:10,000"/>
      <rule scalemaxdenom="3701" filter="featurecode = 15743 OR featurecode = 15740" scalemindenom="1000" label="B road names - 1:1,000 to 1:3,701"/>
      <rule scalemaxdenom="6500" filter="featurecode = 15743 OR featurecode = 15740" scalemindenom="3701" label="B road names - 1:3,701 to 1:6,500"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="flat"/>
          <prop k="color" v="242,210,177,255"/>
          <prop k="customdash" v=""/>
