...
<qgis version="2.0.1-Dufour" minimumScale="-4.65661e-10" maximumScale="1e+08" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="0" scaleBasedLabelVisibilityFlag="0">
  <renderer-v2 symbollevels="0" type="RuleRenderer">
    <rules>
      <rule scalemaxdenom="3701" filter="featurecode = 15700" symbol="0" scalemindenom="1000" label="Road casing - 1:1,000 to 1:3,701"/>
      <rule scalemaxdenom="10001" filter="featurecode = 15700" symbol="1" scalemindenom="3701" label="Road casing - 1:3,701 to 1:10,000"/>
    </rules>
    <symbols>
      <symbol alpha="1" type="line" name="0">
        <layer pass="0" class="SimpleLine" locked="0">
          <prop k="capstyle" v="square"/>
          <prop k="color" v="0,0,106,255"/>
