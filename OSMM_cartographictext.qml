...
<qgis version="2.0.1-Dufour" minimumScale="1" maximumScale="6000" minLabelScale="0" maxLabelScale="1e+08" hasScaleBasedVisibilityFlag="1" scaleBasedLabelVisibilityFlag="0">
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Color" value="1~~1~~CASE WHEN  &quot;descriptive_group&quot; = 'Inland Water'  THEN &#xa;(CASE WHEN &quot;descriptive_group&quot; = 'Political Or Administrative' THEN '#FF00FF' ELSE '#0099FF' END) ELSE &#xa;(CASE WHEN &quot;descriptive_group&quot; = 'Tidal Water' THEN '0099FF' ELSE '#000000' END) END~~"/>
